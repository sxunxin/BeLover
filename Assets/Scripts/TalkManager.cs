...
public class TalkManager : MonoBehaviour
{
    ...
    public string[] S4Text =
    {
        ...
        "저를...요?",
        "응. 이 어두운 곳에서 힘들지 않아?",
        "어둠 속에 있으면 누군가를 볼 일도 없고 마음이 편한걸요...",
        "하지만 아무도 못 봐서 외롭지 않아?",
    ...
    public string[] S5Text = 
    {
        "보스 유령이 쫓아오고 있다!!!\n\n지금까지 받은 아이템들을 이용해 최종 보스를 성불시켜라.\n\n거울은 귀신의 속도에, 블럭은 무너진 다리에, 촛불은 시야에 사용된다.\n\n단, 귀신을 성불하는데에는 거울 1개, 블럭 1개, 촛불 5개가 필요하다."
    };
